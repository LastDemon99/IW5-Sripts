...
namespace Random_Shotgun
{
    public class RandomShotgun : BaseScript
    {
        public RandomShotgun()
        {
            InfiniteStock();
            Credits();
        ...
        private void OnConnected(Entity player)
        {
            ...
            WelcomeGameMode(player, "Random Shotgun", new float[] { 0, 0, 1 });

            player.SetClientDvar("ui_mapname", "Random Shotgun");
            player.SetClientDvar("ui_gametype", "Random Shotgun");
        ...
        {
            int index = GSCFunctions.RandomIntRange(0, Shotguns.Length);
            string weapon = Shotguns[index];
        ...
        private static void Credits()
        {
            ...
            InfinityScript.Log.Write(LogLevel.Info, "-     Lethal Beats: Random Shotgun Game Mode by LastDemon99     -");
            InfinityScript.Log.Write(LogLevel.Info, "-----------------------------------------------------------------");

            GSCFunctions.MakeDvarServerInfo("didyouknow", "^2Random Shotgun script by LastDemon99");
            GSCFunctions.MakeDvarServerInfo("g_motd", "^2Random Shotgun script by LastDemon99");
            GSCFunctions.MakeDvarServerInfo("motd", "^2Random Shotgun script by LastDemon99");
        }

        private static readonly string[] Shotguns = {  "iw5_ksg_mp",
                                           "iw5_1887_mp",
                                           "iw5_striker_mp",
                                           "iw5_aa12_mp",
                                           "iw5_usas12_mp",
